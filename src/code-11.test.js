import { returnTen, findMax, totalSum, grandTotal, salesData } from './code-11.js';
...
it.skip('findMax takes in a matrix of positive numbers and returns the number with the highest value', () => {
  expect(findMax([[13, 24, 24, 2], [2, 5, 6], [2, 3]])).toStrictEqual(24);
});

it.skip('totalSum takes in a matrix of positive numbers and returns the sum of all the numbers', () => {
  expect(totalSum([[13, 24, 24, 2], [2, 5, 6], [2, 3]])).toStrictEqual(81);
  expect(totalSum([])).toStrictEqual(0);
});

it.skip('grandTotal adds up the cookies sales for each hour of operation for all of the stores combined.', () => {
  expect(grandTotal([[13, 24, 24, 2], [2, 5, 6], [2, 3]])).toStrictEqual(24);
});

it.skip('It should create an object of data for each store', () => {
